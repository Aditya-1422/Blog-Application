...
const EditPosts = () => {
    ...
    const deleteCategory = (i) => {
        ...
        updatedCats.splice(i, 1); // Remove the specific category at index i
        setCats(updatedCats);
    };
                ...
                <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4'>
                    ...
                    <div className='flex flex-col'>
                        <div className='flex items-center space-x-4 md:space-x-8'>
                            ...
                            <div onClick={addCategory} className='bg-black text-white px-4 py-2 font-semibold cursor-pointer'>Update</div>
                        </div>
                    ...
                    <button className='bg-black w-full md:w-[20%] mx-auto text-white font-semibold px-4 py-2 md:text-xl text-lg'>Edit</button>
                </form>
            </div>
            <Footer />
        </div>
